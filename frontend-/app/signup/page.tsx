    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Join EcoFinds</h1>
          <p className="text-gray-600 mt-2">Start your sustainable shopping journey today</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center justify-center gap-2 text-green-800 mb-2">
              ...
              <span className="font-medium">Join the Green Revolution</span>
            </div>
            <p className="text-xs text-green-700">
              Every account created helps build a more sustainable future. Start making an impact today!
            </p>
          </div>
        </div>
      </div>
